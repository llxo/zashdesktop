...
const zhTW: LANG_MESSAGE = {
  ...
  coreConfig: '設定檔',
  coreConfigURL: '連結',
  coreConfigSaveTo: '儲存至',
  coreImportConfig: '匯入',
  coreConfigImportSuccess: '設定檔匯入成功',
  coreConfigDownloadSuccess: '核心設定檔下載成功',
  ...
  coreChannel: '通道',
  switchCore: '切換核心',
  switchToStable: '切換到 stable',
  switchToTest: '切換到 test',
  ...
  coreBehavior: '行為',
  coreRunAsAdmin: '以系統管理員身分執行',
  coreAutoStart: '開機自我啟動(需要系統管理員)',
  autoStartSingBox: '程式啟動時開啟 sing-box',
  autoStartMihomo: '程式啟動時開啟 mihomo',
  ...
  appUpdating: '正在下載並套用更新...',
  appUpdateSuccess: '更新已完成，正在重啟應用程式...',
  coreActiveConfig: '生效設定',
  noConfigFilesFound: '未偵測到設定檔',
  coreConfigFileDeleted: '設定檔已刪除',
  coreConfigFileRestored: '設定檔已還原',
  undo: '復原',
  noProxies: '暫無節點',
