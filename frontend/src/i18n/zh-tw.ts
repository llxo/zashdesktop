...
const zhTW: LANG_MESSAGE = {
  ...
  coreSettings: '核心設定',
  coreDownload: '下載核心',
  coreDownloadURL: '核心下載位址',
  coreDownloadURLPlaceholder: '貼上 GitHub Release ZIP 位址',
  coreDownloadURLTip: '自動識別版本，並用 {version} 替換版本號。',
  coreRun: '執行核心',
  coreRunTip: '透過命令列啟動 sing-box，不會修改核心設定檔。',
  coreRunning: '執行中',
  coreStopped: '已停止',
  coreRunArgs: '命令列參數',
  coreRunArgsPlaceholder: 'run -c config.json -D .',
  coreRunArgsTip: '參數會直接傳給 sing-box，不經過命令列解譯器。',
  coreStart: '啟動',
  coreStop: '停止',
  coreRestart: '重新啟動',
  coreProcess: '處理程序 ID',
  coreLogPath: '記錄檔路徑',
  coreRunArgsSaved: '執行參數已儲存',
  coreStarted: '核心已啟動',
  coreStoppedSuccess: '核心已停止',
  coreConfigDownload: '下載 sing-box 設定',
  coreConfigDownloadTip: '下載原始內容並寫入 sing-box/config.json。',
  coreConfigURLPlaceholder: '貼上設定下載位址',
  coreConfigPath: '設定路徑',
  downloadConfig: '下載設定',
  coreConfigAvailable: '設定檔已存在',
  coreConfigDownloadSuccess: 'sing-box 設定下載成功',
  coreLatestVersion: '最新版本',
  coreUpdateAvailable: '有可用更新',
  coreUpToDate: '目前已是最新版本',
  coreUpdatePending: '新核心已下載，現有核心結束後會自動替換。',
  checkUpdate: '檢查更新',
  updateCore: '更新核心',
  coreVersion: '版本',
  coreChannel: '頻道',
  coreStableBuild: '穩定版',
  coreTestBuild: '測試版',
  coreInstallStatus: '安裝狀態',
  coreInstalled: '已安裝',
  coreNotInstalled: '未安裝',
  corePath: '核心路徑',
  downloadCore: '下載並替換',
  coreURLSaved: '核心位址已儲存',
  coreDownloadSuccess: '核心下載並替換成功',
  actions: '操作',
  showAllPreset: '全部顯示',
  minimalPreset: '精簡顯示',
