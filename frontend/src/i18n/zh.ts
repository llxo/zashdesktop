const zh = {
  ...
  coreDownloadURLTip: '自动识别版本，并用 {version} 替换版本号。',
  coreRun: '运行核心',
  coreRunStatus: '运行状态',
  coreRunTip: '通过命令行启动 sing-box，不会修改核心配置文件。',
  coreRunning: '运行中',
  coreStopped: '已停止',
  coreRunArgs: '命令行参数',
  coreRunArgsPlaceholder: 'mihomo: -d . -f config.yaml；sing-box: run -c config.json -D .',
  coreRunArgsTip: '参数会直接传给当前核心，不经过命令行解释器。',
  coreStart: '启动',
  coreStop: '停止',
  coreRestart: '重启',
  coreProcess: '进程 ID',
  coreLogPath: '日志路径',
  coreRunArgsSaved: '运行参数已保存',
  coreStarted: '核心已启动',
  coreStoppedSuccess: '核心已停止',
  coreConfigDownload: '下载核心配置',
  coreConfigDownloadTip: '下载原始内容并写入当前核心的配置文件。',
  coreConfigURLPlaceholder: '粘贴配置下载地址',
  coreConfigPath: '配置路径',
  downloadConfig: '下载',
  coreConfigAvailable: '配置文件已存在',
  coreConfigMissing: '未下载',
  coreConfig: '配置文件',
  coreConfigURL: '链接',
  coreConfigSaveTo: '保存到',
  coreImportConfig: '导入',
  coreConfigImportSuccess: '配置导入成功',
  coreConfigDownloadSuccess: '核心配置下载成功',
  ...
  coreStableBuild: '稳定版',
  coreTestBuild: '测试版',
  coreInstallStatus: '安装状态',
  coreInstalled: '已安装',
  coreNotInstalled: '未安装',
  corePath: '核心路径',
  downloadCore: '下载并替换',
  coreURLSaved: '核心地址已保存',
