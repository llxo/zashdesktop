...
const zh: LANG_MESSAGE = {
  ...
  coreRunArgsTip: '参数会直接传给 sing-box，不经过命令行解释器。',
  coreStart: '启动',
  coreStop: '停止',
  coreRestart: '重启',
  coreProcess: '进程 ID',
  ...
  coreConfigDownload: '下载 sing-box 配置',
  coreConfigDownloadTip: '下载原始内容并写入 sing-box/config.json。',
  coreConfigURLPlaceholder: '粘贴配置下载地址',
  coreConfigPath: '配置路径',
  downloadConfig: '下载配置',
  coreConfigAvailable: '配置文件已存在',
  coreConfigDownloadSuccess: 'sing-box 配置下载成功',
