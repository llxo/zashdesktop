const zh = {
  ...
  fonts: '面板字体',
  systemDefault: '系统默认',
  recommendedFonts: '常用推荐',
  systemFonts: '系统已安装字体',
  customFont: '自定义字体',
  customFontTip: '输入本地已安装的字体族名称（例如 "霞鹜文楷"、"Segoe UI" 或 "Consolas"）',
  customFontPlaceholder: '例如：Microsoft YaHei, Segoe UI',
  searchFonts: '搜索字体...',
  fontPreview: '预览：Antigravity 节点 012345 - 香港 🇭🇰 日本 🇯🇵',
  installed: '已安装',
  currentCustomFont: '当前自定义',
  emoji: 'Emoji',
  ...
  coreConfigDownloadSuccess: '配置下载成功',
