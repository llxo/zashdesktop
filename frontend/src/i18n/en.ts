const en = {
  ...
  coreConfigURL: 'URL',
  coreConfigSaveTo: 'Save to',
  coreImportConfig: 'Import',
  coreConfigImportSuccess: 'Config imported successfully',
  coreConfigDownloadSuccess: 'Config downloaded successfully',
  ...
  coreDownloadSuccess: 'Core downloaded and installed successfully',
  coreBehavior: 'Behavior',
  coreRunAsAdmin: 'Run as Administrator',
  coreAutoStart: 'Auto start (requires Admin)',
  ...
  appUpdating: 'Downloading and applying update...',
  appUpdateSuccess: 'Update completed, restarting app...',
  coreActiveConfig: 'Active config',
  noConfigFilesFound: 'No config files found',
  coreConfigFileDeleted: 'Config file deleted',
  coreConfigFileRestored: 'Config file restored',
  undo: 'Undo',
