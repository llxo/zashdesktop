const en = {
  ...
  coreDownload: 'Download core',
  coreDownloadURL: 'Core download URL',
  coreDownloadURLPlaceholder: 'Paste a GitHub release ZIP URL',
  coreDownloadURLTip: 'The version is detected automatically and replaced with {version}.',
  coreRun: 'Run core',
  coreRunTip: 'Start sing-box from the command line. The core configuration is not modified.',
  coreRunning: 'Running',
  coreStopped: 'Stopped',
  coreRunArgs: 'Command-line arguments',
  coreRunArgsPlaceholder: 'run -c config.json -D .',
  coreRunArgsTip: 'Arguments are passed directly to sing-box without a shell.',
  coreStart: 'Start',
  coreStop: 'Stop',
  coreRestart: 'Restart',
  coreProcess: 'Process ID',
  coreLogPath: 'Log path',
  coreRunArgsSaved: 'Run arguments saved',
  coreStarted: 'Core started',
  coreStoppedSuccess: 'Core stopped',
  coreConfigDownload: 'Download sing-box config',
  coreConfigDownloadTip: 'Download the raw content and write it to sing-box/config.json.',
  coreConfigURLPlaceholder: 'Paste a configuration URL',
  coreConfigPath: 'Config path',
  downloadConfig: 'Download config',
  coreConfigAvailable: 'Config file available',
  coreConfigDownloadSuccess: 'sing-box config downloaded',
  coreLatestVersion: 'Latest version',
  coreUpdateAvailable: 'An update is available',
  coreUpToDate: 'Already up to date',
  coreUpdatePending: 'The new core will replace the current one after it exits.',
  checkUpdate: 'Check for updates',
  updateCore: 'Update core',
  coreVersion: 'Version',
  coreChannel: 'Channel',
  coreStableBuild: 'Stable',
  coreTestBuild: 'Test build',
  coreInstallStatus: 'Install status',
  coreInstalled: 'Installed',
  coreNotInstalled: 'Not installed',
  corePath: 'Core path',
  downloadCore: 'Download and replace',
  coreURLSaved: 'Core URL saved',
  coreDownloadSuccess: 'Core downloaded and replaced successfully',
  actions: 'Actions',
