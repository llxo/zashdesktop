...
const ru: LANG_MESSAGE = {
  ...
  settingsMenuCore: 'Ядро',
  settingsMenuProxies: 'Прокси',
  settingsMenuConnections: 'Подключения',
  settingsMenuOverview: 'Обзор',
  ports: 'Порты',
  coreSettings: 'Настройки ядра',
  coreDownload: 'Загрузить ядро',
  coreDownloadURL: 'URL загрузки ядра',
  coreDownloadURLPlaceholder: 'Вставьте URL ZIP из GitHub Release',
  coreDownloadURLTip: 'Версия определяется автоматически и заменяется на {version}.',
  coreRun: 'Запуск ядра',
  coreRunTip: 'Запустить sing-box из командной строки. Конфигурация ядра не изменяется.',
  coreRunning: 'Запущено',
  coreStopped: 'Остановлено',
  coreRunArgs: 'Аргументы командной строки',
  coreRunArgsPlaceholder: 'run -c config.json -D .',
  coreRunArgsTip: 'Аргументы передаются sing-box напрямую, без оболочки.',
  coreStart: 'Запустить',
  coreStop: 'Остановить',
  coreRestart: 'Перезапустить',
  coreProcess: 'ID процесса',
  coreLogPath: 'Путь к журналу',
  coreRunArgsSaved: 'Аргументы запуска сохранены',
  coreStarted: 'Ядро запущено',
  coreStoppedSuccess: 'Ядро остановлено',
  coreConfigDownload: 'Загрузка конфигурации sing-box',
  coreConfigDownloadTip: 'Загрузить исходное содержимое и записать его в sing-box/config.json.',
  coreConfigURLPlaceholder: 'Вставьте URL конфигурации',
  coreConfigPath: 'Путь к конфигурации',
  downloadConfig: 'Загрузить конфигурацию',
  coreConfigAvailable: 'Файл конфигурации доступен',
  coreConfigDownloadSuccess: 'Конфигурация sing-box загружена',
  coreLatestVersion: 'Последняя версия',
  coreUpdateAvailable: 'Доступно обновление',
  coreUpToDate: 'Установлена последняя версия',
  coreUpdatePending: 'Новое ядро заменит текущее после его завершения.',
  ...
  coreInstallStatus: 'Статус установки',
  coreInstalled: 'Установлено',
  coreNotInstalled: 'Не установлено',
  corePath: 'Путь к ядру',
  downloadCore: 'Загрузить и заменить',
  coreURLSaved: 'URL ядра сохранён',
  coreDownloadSuccess: 'Ядро загружено и заменено',
  actions: 'Действия',
