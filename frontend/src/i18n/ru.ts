...
const ru: LANG_MESSAGE = {
  ...
  coreStopped: 'Остановлен',
  coreRunArgs: 'Параметры запуска',
  coreStart: 'Запустить',
  coreStop: 'Остановить',
  ...
  coreConfigURL: 'Ссылка',
  coreConfigSaveTo: 'Сохранить как',
  coreImportConfig: 'Импорт',
  coreConfigImportSuccess: 'Конфигурация успешно импортирована',
  coreConfigDownloadSuccess: 'Конфигурация ядра успешно скачана',
  ...
  coreAdvanced: 'Дополнительно',
  coreChannel: 'Канал',
  switchCore: 'Переключить ядро',
  switchToStable: 'Переключить на stable',
  switchToTest: 'Переключить на test',
  ...
  coreDownloadSuccess: 'Ядро успешно загружено и обновлено',
  coreBehavior: 'Поведение',
  coreRunAsAdmin: 'Запуск от имени администратора',
  coreAutoStart: 'Автозапуск (требуются права администратора)',
  ...
  appUpdating: 'Загрузка и применение обновления...',
  appUpdateSuccess: 'Обновление завершено, перезапуск...',
  coreActiveConfig: 'Активный конфиг',
  noConfigFilesFound: 'Конфигурационные файлы не найдены',
  coreConfigFileDeleted: 'Файл конфигурации удален',
  coreConfigFileRestored: 'Файл конфигурации восстановлен',
  undo: 'Отменить',
  noProxies: 'Нет узлов',
